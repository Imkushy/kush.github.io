...
const clickSound = new Audio('storage/Uwu-Sound-Effect.mp3');
const profileImage = document.querySelector('.image-wrapper');
function playClickSound() {
    const newClickSound = new Audio('storage/Uwu-Sound-Effect.mp3');
    newClickSound.play();
    console.log("quack 🦆")
}
...
username.addEventListener('click', function() {
    navigator.clipboard.writeText("Kush");
    username.innerHTML = "Copied to clipboard!";
    setTimeout(function() {
       username.innerHTML = "Kush";
